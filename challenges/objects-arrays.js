...
console.log(`${tyraDinosaurs.weight}kg`);

// What was the diet of a velociraptor?
console.log(`${veloDinosaurs.diet}`);

// How long was a stegosaurus?
console.log(`${stegoDinosaurs.length}m`);

// What time period did tyrannosaurus live in?
console.log(`${tyraDinosaurs.period}`);


// Create a new roar method for the tyrannosaurus.  When called, return "RAWERSRARARWERSARARARRRR!" Log the result.

tyraDinosaurs.roar = function () {
  return `RAWERSRARARWERSARARARRRR!`
}

console.log(tyraDinosaurs.roar());
...
*/
const populationTotal = zooAnimals.reduce((sumOfPopulation, zooAnimal) => sumOfPopulation + zooAnimal.population, 0);
